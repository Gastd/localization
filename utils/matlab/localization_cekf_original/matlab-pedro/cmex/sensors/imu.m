...
function [imumeasure] = imu(vehiclestate,G,flagnoise,accel_noise_multiplier)
...
%0.0213 m/s^2 em z
%adicionando os erros de medição
imumeasure.ax = imumeasure.ax + flagnoise*sqrt(imumeasure.axvariance*accel_noise_multiplier)*randn(1);
imumeasure.ay = imumeasure.ay + flagnoise*sqrt(imumeasure.ayvariance*accel_noise_multiplier)*randn(1);
imumeasure.az = imumeasure.az + flagnoise*sqrt(imumeasure.azvariance*accel_noise_multiplier)*randn(1);
