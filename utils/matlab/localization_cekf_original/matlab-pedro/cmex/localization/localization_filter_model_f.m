%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function var_out = localization_filter_model_f(procedure_name,x,u,G,T,flagestimateaccelerometerbias)
% x : [q; p; v]
...
switch procedure_name
    ...
    case 'evaluate'
        ...
        if flagestimateaccelerometerbias
            %Aceleracao transformada do sistema do corpo para o sistema de
            %referencia e descontada dos biases.
        ...
        %Predicao da posicao e da velocidade de translacao
        ...
        %Armazena a posição
        var_out(1:4,1)  = q;    %   Quaternio predito (modelo)
        var_out(5:7,1)  = p;    %   Posicao predita (modelo)
        var_out(8:10,1) = v;    %   Velocidade de translacao predita (modelo)
        
        % parâmetros:
        if flagestimateaccelerometerbias
            %Simplesmente repete os biases dos acelerometros
