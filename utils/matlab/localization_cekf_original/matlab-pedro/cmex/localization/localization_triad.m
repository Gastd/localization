%função que calcula a atitude a partir dos dados dos magnetômetros e do
%acelerômetro
...
%armazena a aceleração (força específica). A aceleração é negada, pois leva-se em conta que os
