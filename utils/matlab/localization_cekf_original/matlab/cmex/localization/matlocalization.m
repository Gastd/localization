function result = localization(proceedurestrg, varargincell)
...
% Algoritmo FKE aplicado à arquitetura correlata: etapa de predição
...
% Algoritmo FKEC aplicado à arquitetura correlata: etapa de predição
...
% Algoritmo FKE aplicado à arquitetura correlata: etapa de correção
...
% Algoritmo FKEC aplicado à arquitetura correlata: etapa de correção
...
% Algoritmo RUNGEKUTTA para integração do modelo cinemático
