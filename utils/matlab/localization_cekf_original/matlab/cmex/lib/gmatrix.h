...
#define  GMATRIX_DEFINE_SUBTRACT_COPY					(0 + GMATRIX_DEFINE_ALL)
#define  GMATRIX_DEFINE_SUBTRACT_IDENTITY_COPY			(0 + GMATRIX_DEFINE_ALL)
#define  GMATRIX_DEFINE_SUBTRACT_IDENTITY				(0 + GMATRIX_DEFINE_ALL)
#define  GMATRIX_DEFINE_SUBTRACT						(0 + GMATRIX_DEFINE_ALL)
...
#define  GMATRIX_DEFINE_MULTIPLY_SUBTRACT				(0 + GMATRIX_DEFINE_ALL)
...
void PGMATRIX_SUBTRACT_COPY(PGMATRIX pMatResult, PGMATRIX pMatA, PGMATRIX pMatB);

#define GMATRIX_SUBTRACT_IDENTITY_COPY(MatResult, Mat) PGMATRIX_SUBTRACT_IDENTITY_COPY(&MatResult, &Mat)
void PGMATRIX_SUBTRACT_IDENTITY_COPY(PGMATRIX pMatResult, PGMATRIX pMat);

#define GMATRIX_SUBTRACT_IDENTITY(Mat) PGMATRIX_SUBTRACT_IDENTITY(&Mat)
void PGMATRIX_SUBTRACT_IDENTITY(PGMATRIX pMat);

#define GMATRIX_SUBTRACT(MatA, MatB) PGMATRIX_SUBTRACT(&MatA, &MatB)
void PGMATRIX_SUBTRACT(PGMATRIX pMatA, PGMATRIX pMatB);
...
#define GMATRIX_MULTIPLY_SUBTRACT(MatResult, MatA, MatB) PGMATRIX_MULTIPLY_SUBTRACT(&MatResult, &MatA, &MatB)
void PGMATRIX_MULTIPLY_SUBTRACT(PGMATRIX pMatResult, PGMATRIX pMatA, PGMATRIX pMatB) ;
