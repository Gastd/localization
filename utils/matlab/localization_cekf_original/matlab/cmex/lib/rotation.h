...
Arquivo: rotation.h 
Conteudo: Cabeï¿½alho de funï¿½ï¿½es em cï¿½digo C de manipulaï¿½ï¿½o de matrizes de cosseno diretores (DCM).
Autor: G. A. Borges.
Atualizaï¿½ï¿½es: 
	- 28/07/2008: criaï¿½ï¿½o do exemplo, por Geovany A. Borges
*****************************************************************************/
