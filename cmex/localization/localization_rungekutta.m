%Fun��o que estima a posi��o, velocidade e atitude pelo m�todo de Runge
%Kuta
function  [pose_estimator_state] = localization_rungekutta(pose_estimator_state, imu_measurements, G, T)

%preserva a posi��o e suas 1�  derivadas
...
% ac garantir� que o modulo do quaternio ser� unitario
...
% Formata��o do quat�rnio
rk = [ac;
    as*sigma_x;
    as*sigma_y;
    as*sigma_z];

%% calcula a nova matriz de rota��o
