%Esta funcao gera as variaveis de estado (atitude, posicao, velocidade,
%rotacoes) para um corpo que descreve uma determinada trajetoria (helix ou 
%hovering).
...
if strcmp(trajectory_name,'trajectory_helix')
   ...
   vz = 0.05; % vertical speed in m/s
   wxy = 10*pi/180; % rotational speed in rad/s
   r = 4; % circle radius
